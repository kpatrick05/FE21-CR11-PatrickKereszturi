...
$error = false;
$fname = $lname = $email = $date_of_birth = $pass = $picture = $telnumber = $address = '';
$fnameError = $lnameError = $emailError = $dateError = $passError = $picError = $telnumberError = $addressError = '';
if (isset($_POST['btn-signup'])) {
    ...
    $telnumber = strip_tags($telnumber);
    ...
    if (!$error) {
        ...
        $query = "INSERT INTO users(first_name, last_name, password, date_of_birth, email, telnumber, address, picture)
                  VALUES('$fname', '$lname', '$password', '$date_of_birth', '$email', '$telnumber', '$address',  '$picture->fileName')";
...
<div class="container">
   <form class="w-75" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off" enctype="multipart/form-data">
            ...
            <input type="email" name="email" class="form-control" placeholder="Enter Your Email" maxlength="40" value ="<?php echo $email ?>"  />
               ...
               <input type="text" name="telnumber" class="form-control" placeholder="Enter Your Telnumber" maxlength="40" value ="<?php echo $telnumber ?>"  />
               <span  class="text-danger"> <?php echo $telnumberError; ?> </span>
